...
@mcp.tool()
def list_source_files(database_path: str = Field(description="The CodeQL database path."),
...
@mcp.tool()
def search_in_source_code(database_path: str = Field(description="The CodeQL database path."),
...
@mcp.tool()
def definition_location_for_function(target_definition: str = Field(description="The function to get the source code location file URI of its definition for."),
                          database_path: str = Field(description="The CodeQL database path."),
    ...
    return _run_query('definition_location_for_function', database_path, language, {'targetDefinition': target_definition})


@mcp.tool()
def declaration_location_for_variable(target_declaration: str = Field(description="The variable to get the source code location file URI of its declaration for."),
                          database_path: str = Field(description="The CodeQL database path."),
                          language: str = Field(description="The language used for the CodeQL database.")):
    ...
    return _run_query('declaration_location_for_variable', database_path, language, {'targetDeclaration': target_declaration})

@mcp.tool()
def statement_location(target_statement: str = Field(description="The type of statement to get the source code location file URI of its definition for."),
                       database_path: str = Field(description="The CodeQL database path."),
                       language: str = Field(description="The language used for the CodeQL database.")):
...
@mcp.tool()
def call_graph_to(target_function: str = Field(description="The target function to get calls to."),
                          database_path: str = Field(description="The CodeQL database path."),
                          language: str = Field(description="The language used for the CodeQL database.")):
...
@mcp.tool()
def call_graph_from(source_function: str = Field(description="The source function to get calls from."),
                            database_path: str = Field(description="The CodeQL database path."),
                            language: str = Field(description="The language used for the CodeQL database.")):
...
@mcp.tool()
def call_graph_from_to(source_function: str = Field(description="The source function for the call path."),
    ...
    return _run_query('call_graph_from_to', database_path, language, {'sourceFunction': source_function, 'targetFunction': target_function})


@mcp.tool()
def list_functions(database_path: str = Field(description="The CodeQL database path."),
                   language: str = Field(description="The language used for the CodeQL database.")):
